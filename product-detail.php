                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      ...
                      <div class="simpleLens-thumbnails-container">
                          <a data-big-image="itemImage/<?php echo $row['image'] ?>" data-lens-image="itemImage/<?php echo $row['image'] ?>" class="simpleLens-thumbnail-wrapper" href="#">
                            <img src="itemImage/<?php echo $row['image'] ?>" width ="250px" height ="300px">
                          </a>                                    
                      </div>
                    </div>
                  </div>
                              ...
                              <div class="simpleLens-container">
                                  <div class="simpleLens-big-image-container">
                                      <a class="simpleLens-lens-image" data-lens-image="itemImage/<?php echo $row['image'] ?>">
                                          <img src="itemImage/<?php echo $row['image'] ?>" width ="900px" height ="1024px" class="simpleLens-big-image">
                                      </a>
                                  </div>
                              </div>
                              <div class="simpleLens-thumbnails-container">
