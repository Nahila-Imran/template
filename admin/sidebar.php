<div id="sidebar">
    ...
    $productmenu = array('addMproduct.php', 'categories.php','tags.php');
    ...
    ?>
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
                    ...
                    <li><a <?php if($filename=='addMproduct.php'): ?>class="current"<?php endif; ?> href="addMproduct.php">Manage Products</a></li> <!-- Add class "current" to sub menu items also -->
				...
				<li>
					...
					<ul>   
						<li><a  <?php if($filename=='users.php.php'): ?>class="current"<?php endif; ?> href="users.php">Manage Users</a></li>
					</ul>
                </li>
