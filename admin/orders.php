					...
					<div class="tab-content" id="tab2">
						...
						<form action="#" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Name</label>
										<input class="text-input medium-input datepicker" type="text" id="medium-input" name="medium-input" />  <!-- Classes for input-notification: success, error, information, attention -->
								</p>
