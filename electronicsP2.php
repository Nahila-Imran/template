...
?>
            ...
            <div class="aa-product-catg-body">
              ...
              <?php
                $sql =  "SELECT * FROM products ORDER BY id ASC LIMIT 9 OFFSET 63";
            ...
            ?>
                ...
                <figure>
                  <form action="" class="form-submit">
                    ...
                    <a class="aa-product-img" href="#"><img src="itemImage/<?php echo $row["image"];?>" alt="suit img" width ="250px" height ="300px"></a>
            ...
            <div class="aa-product-catg-pagination">
              <nav>
                <ul class="pagination">
                  ...
                  <li><a href="electronicsProduct.php">1</a></li>
                  <li><a href="electronicsP2.php">2</a></li>
                  <li><a href="#">3</a></li>
                  <li><a href="#">4</a></li>
                  <li><a href="#">5</a></li>
                  <li>
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-sidebar-price-range">
               <form action="">
                  ...
                  <span id="skip-value-lower" class="example-val">00.00</span>
